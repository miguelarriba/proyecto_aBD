    ...
    */
    public function __construct() {
		...
		if($ini_array==null)
			...
			$this->servername=$ini_array['BLOGGS']['servername'];
			$this->username=$ini_array['BLOGGS']['username'];
			$this->password=$ini_array['BLOGGS']['password'];
			$this->database=$ini_array['BLOGGS']['database'];
